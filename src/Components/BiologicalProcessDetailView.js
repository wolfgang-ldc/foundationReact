...
const BiologicalProcessDetailView = (props) => {
                ...
                <Table className={classes.table} aria-label="simple table">
                    <TableHead stickyHeader aria-label="sticky table">
                        <TableRow>
                            ...
                            <TableCell align="left">FinanceStatus</TableCell>
                    ...
                    <TableBody>
                        ...
                        <TableRow key={row.FID}>
                            ...
                            <TableCell align="left">{row.FoundationYear}</TableCell>
                            <TableCell component="th" scope="row">
                                <Link to={`/companysummary/${row.FID_S}`} >{row.Name}</Link>
                            </TableCell>
                            <TableCell component="th" scope="row">{row.FinanceStatus}</TableCell>
...
export default  BiologicalProcessDetailView;