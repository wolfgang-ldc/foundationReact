...
const SummarySourceReferenceDetail = (props) => {
                ...
                <Table stickyHeader aria-label="simple table">
                    <TableHead aria-label="sticky table">
                        <StyledTableRow>
                            ...
                            <StyledTableCell align="left">Related Items</StyledTableCell>
                        </StyledTableRow>
                    </TableHead>
                    <TableBody>
...
export default SummarySourceReferenceDetail;